...
export const STYLE_REGISTRY = {
  ...
  nav: {
    bar: { backgroundType: "gradient", gradientKey: "warm", textColorIndex: 3 },
    logo: { fontFamily: "display" },
    link: { textColorIndex: 1, hoverBackgroundIndex: 8, hoverTextIndex: 2 },
    cta: { borderRadius: "9999px" },
  } satisfies NavStyles,

  hero: {
    section: { backgroundIndex: 8, patternOpacity: 0.6 },
    badge: { backgroundIndex: 2, textColorIndex: 3, borderRadius: "9999px" },
    quote: { fontSize: "1.125rem", textColorIndex: 1 },
    heading: { fontSize: "3rem", fontFamily: "display", textColorIndex: 1 },
    description: { textColorIndex: 6 },
    primaryButton: { backgroundType: "gradient", gradientKey: "warm", textColorIndex: 3, borderRadius: "9999px" },
    secondaryButton: { borderColorIndex: 2, backgroundIndex: 0, textColorIndex: 2, borderRadius: "9999px" },
    footer: { textColorIndex: 1 },
    image: {
    ...
    divider: DEFAULT_DIVIDER(8, 0, "wavy"),
  } satisfies HeroStyles,

  why: {
    section: { backgroundIndex: 0 },
    card: [
      { backgroundIndex: 8, accentColorIndex: 2 },
      { backgroundIndex: 10, accentColorIndex: 4 },
      { backgroundIndex: 11, accentColorIndex: 7 },
    ],
    cardBorderRadius: "1.5rem",
    cardShadow: "playful",
    ctaButton: { gradientKey: "warm", textColorIndex: 3, borderRadius: "9999px" },
    images: [
      { path: "problem-1.jpg" },
      { path: "problem-2.jpg" },
      { path: "problem-3.jpg" },
    ],
    divider: DEFAULT_DIVIDER(0, 9, "blob"),
  } satisfies WhyStyles,

  howItWorks: {
    section: { backgroundIndex: 9 },
    stepCard: [
    ...
    divider: DEFAULT_DIVIDER(9, 10, "wavy2"),
  } satisfies HowItWorksStyles,

  compatibilityTest: {
    section: { backgroundIndex: 10 },
    triggerButton: { backgroundIndex: 2, textColorIndex: 3, borderRadius: "9999px" },
    divider: DEFAULT_DIVIDER(10, 8, "wavy"),
  } satisfies CompatibilityTestStyles,
  ...
  pastEditions: {
    section: { backgroundIndex: 0 },
    divider: DEFAULT_DIVIDER(0, 11, "sawtooth"),
  } satisfies PastEditionsStyles,

  experience: {
    section: { backgroundIndex: 11 },
    divider: DEFAULT_DIVIDER(11, 12, "wavy2"),
  } satisfies ExperienceStyles,

  testimonials: {
    section: { backgroundIndex: 12 },
    divider: DEFAULT_DIVIDER(12, 9, "wavy"),
  } satisfies TestimonialsStyles,

  pricing: {
    section: { backgroundIndex: 9 },
    card: { backgroundIndex: 13, borderRadius: "1.5rem", shadow: "playful" },
    cardBorderByAccent: { lavender: 10, peach: 2, mint: 11 },
    badge: { backgroundIndex: 12 },
    ctaButton: { gradientKey: "warm", textColorIndex: 3, borderRadius: "9999px" },
    divider: DEFAULT_DIVIDER(9, 10, "blob"),
  } satisfies PricingStyles,

  faq: {
    section: { backgroundIndex: 10 },
    divider: DEFAULT_DIVIDER(10, 9, "wavy2"),
  } satisfies FaqStyles,
  ...
  finalCta: {
    ...
    ctaButton: { gradientKey: "warm", textColorIndex: 3, borderRadius: "9999px" },
    divider: DEFAULT_DIVIDER(9, 0, "wavy"),
  } satisfies FinalCtaStyles,

  footer: {
    section: { backgroundIndex: 0 },
    heading: { textColorIndex: 1 },
    link: { textColorIndex: 6, hoverColorIndex: 2 },
    input: { borderColorIndex: 8 },
    bottomBar: { borderColorIndex: 8 },
  } satisfies FooterStyles,

  login: {
    page: { backgroundIndex: 0 },
    heading: { fontSize: "1.5rem" },
    error: { backgroundIndex: 15, textColorIndex: 15 },
  } satisfies LoginStyles,
  ...
  forgotPassword: {
    page: { backgroundIndex: 0 },
    heading: { fontSize: "1.5rem" },
  } satisfies Omit<LoginStyles, "error">,
