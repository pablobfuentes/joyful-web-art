...
export const APP_REGISTRY = {
  ...
  deliveryWindows: {
    title: "When will I receive my Skincare?",
    description:
      "Elige la fecha de tu suscripción para ver tus próximas 6 ventanas de envío. Las cajas se envían cada 2 meses, según la quincena en la que te unas.",
    datePickerLabel: "Fecha de suscripción",
    subscriptionGroupLabel: "Tu grupo de envío",
    firstHalf: "First Half",
    secondHalf: "Second Half",
    deliveryListHeading: "Tus próximas 6 ventanas de envío",
    windowFormatFirst: "First Half of {month} {year}",
    windowFormatSecond: "Second Half of {month} {year}"
  },
  testimonials: {
    subtitleEmoji: "⭐",
